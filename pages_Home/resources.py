...
links = [
    ...
    {
        "numero": 1,
        "titulo": "DATOS CLIMÁTICOS Y CONSUMO ELÉCTRICO",
        "descripcion": "Permite analizar y obtener información espacio-temporal de variables climáticas y de consumo eléctrico.",
        "icono": ":partly_cloudy_day:",
